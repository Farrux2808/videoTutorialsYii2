      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" >
          <div class="container-fluid">
              ...
              <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                      <a class="nav-link nav-link-1 active" aria-current="page" href="/">Bosh sahifa</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link nav-link-1" href="<?=\yii\helpers\Url::to(['videos']);?>">Barcha darslar</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link nav-link-1" href="<?=\yii\helpers\Url::to(['about', 'id'=>1])?>">Biz haqimizda</a>
                  </li>
              </ul>
              </div>
          </div>
